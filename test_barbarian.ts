...
import { RunCalculations } from "../graph_based_calculator/run_calculation";

let helmet = new Equipment([["Armor_Bonus", 25]], "helmet", 4);
...
let ring = new Equipment([["Resistance#Cold", .15]], "ring", 2);
ring.ChangeModifier(0, ["Crit_Percent_Bonus", .05]);
ring.ChangeModifier(1, ["Flat_Damage_Bonus", 20]);

let sword = new Equipment([["One_Hand_Slashing_Damage", 150]], "weapon", 4, "OneHandSword", 1.4);
...
const test_return = RunCalculations(Sam);
