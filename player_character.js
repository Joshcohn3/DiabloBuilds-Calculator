...
class PlayerCharacter {
    ...
    RemoveOffHand() {
        ...
        if (weapon_type != null && equipment_1.TwoHandWeaponTypes.has(weapon_type)) {
    ...
    SatisfiesToggleRequirements(toggle) {
        if (!toggle) {
    ...
    UpdateAspectToggles(aspect_name) {
    ...
    UpdateSkillToggles(skill_name, previous_skill_name) {
    ...
    UpdateToggleValue(toggle_name, value) {
...
//# sourceMappingURL=player_character.js.map